    ...
    <main class="bg-[#262929] pt-[1rem] md:pt-[2rem] pb-[6rem] px-[4vw] max-w-[1400px] mx-auto w-full">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-[#927860] pb-[1.5rem] mb-[2.5rem] gap-[1rem] w-full">
            ...
            <div class="flex flex-wrap items-center gap-[0.75rem] w-full sm:w-auto">
                <a href="{{ route('clientbookings.edit', $booking->id) }}" class="w-full sm:w-auto text-center flex items-center justify-center gap-[0.5rem] text-[#413B36] bg-[#D1C7B7] hover:bg-[#EBE6E1] py-[0.5rem] px-[1.25rem] rounded-[0.4rem] border border-[#927860] uppercase no-underline font-bebas text-[1.1rem] shadow-md transition-all duration-300">
                ...
                <a href="{{ route('dashboard') }}" class="w-full sm:w-auto text-center flex items-center justify-center gap-[0.5rem] text-[#E5E5E5] bg-[#413B36] hover:bg-[#101111] py-[0.5rem] px-[1.25rem] rounded-[0.4rem] border border-[#413B36] uppercase no-underline font-bebas text-[1.1rem] shadow-md transition-all duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="bg-[#EBE6E1] rounded-[8px] p-[1.5rem] md:p-[2.5rem] shadow-xl lg:col-span-2 border border-[#413B36]/20 text-[#413B36] font-poppins">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-[2rem] gap-y-[1.25rem] mb-[2.5rem]">
                    ...
                    <div>
                        ...
                        <p class="text-[#413B36] text-[1rem] font-bold mt-[0.1rem]">
                ...
                <div class="mb-[2.5rem]">
                    <p class="text-stone-500 text-[0.75rem] uppercase tracking-wide font-semibold mb-[0.3rem]">Detalles proporcionados:</p>
